        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="page-header">
                        <h3 class="font-weight-bold"></h3><br>
    ...
    <table class="table table-bordered" id="table" width="100%" cellspacing="0">
        <thead style="background-color:blue;color:aliceblue;">
            <tr align="center">
                ...
                <th style="background-color:blue;color:aliceblue;">Status</th>
            ...
            ?>
                <tr>
                    ...
                    <td style="text-align: center;">
                        <button class="btn btn-info toggle-status" data-id="<?php echo $row['id']; ?>" data-status="<?php echo $row['status']; ?>" style="font-size: 20px;">
                            <?php echo ($row['status'] === 'true' || $row['status'] === '1') ? 'Set False' : 'Set True'; ?>
                        </button>
                    </td>
                </tr>
            <?php
...
$(document).ready(function() {
    $('.toggle-status').click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'proses/location/function.php',
            data: { id: id },
            dataType: 'json',
            success: function(response) {
                if (response.success) {
                    ...
                    button.text(response.newStatus === 'true' ? 'Set False' : 'Set True');
                    // Optionally, update the status cell in the row
                    button.closest('tr').find('td:nth-child(2)').text(response.newStatus);
                } else {
