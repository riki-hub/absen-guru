                ...
                <div class="content-wrapper">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex">
                                <a style="margin-top: 5px; margin-left: 5px;" href="proses/cetak/izin.php" target="_blank" class="btn btn-primary btn-icon-split btn-sm">
                                    <span class="icon text-white-55">
                                        <i class="fas fa-print"></i>
                                    </span>
                                    <span class="text">Cetak Data</span>
                                </a>
                                <a style="margin-top: 5px; margin-left: 5px; color:white;" id="delete" data-id="delete" class=" btn btn-danger btn-icon-split btn-sm delete">
                                    <span class="icon text-white-55">
                                ...
                                <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                                    ...
                                    ?>
                                        ...
                                        <tbody style="background-color:white;">
                                            ...
                                            <td><?php
                                                if ($data['status'] == 'Di izinkan') {
                                                    echo '<div class ="badge badge-success" style="width: 100px;" > <b>Di izinkan</b> </div>';
                                                } else if ($data['status'] == 'belum di cek') {
                                                    echo '<div class ="badge badge-warning" style="width: 100px;" > <b>belum di cek</b> </div>';
                                                } else if ($data['status'] == 'Tidak di izinkan') {
                                                    echo '<div class ="badge badge-danger" style="width: 100px;" > <b>Tidak di izinkan</b> </div>';
                                                }
                                                ?></td>
                                            <td style="text-align: center;"><a class="btn btn-primary  delete-btn" style=" color:white;font-size: 20px;" id="delete-btn" data-id="<?php echo $data['id']; ?>"><i class="fa-solid fa-user-check"></i></a></td>
                                        </tbody>
                                        <!-- Modal -->
            ...
            document.querySelectorAll('.delete-btn').forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        ...
                        icon: 'question',
                        showCancelButton: true,
                        confirmButtonText: 'Di izinkan',
                        cancelButtonText: 'Tidak di izinkan'
                    }).then((result) => {
                        if (result.isConfirmed) {
                            saveChoice('Di izinkan', id);

                        } else if (result.dismiss === Swal.DismissReason.cancel) {
                            saveChoice('Tidak di izinkan', id);
                        }
                    });
                });
            });

            function saveChoice(choice, id) {
                // Ganti URL dengan URL server Anda yang akan memproses penyimpanan data
                fetch('proses/izin/save_izin.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
