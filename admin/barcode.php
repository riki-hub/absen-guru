...
if (isset($_GET['namakelas'])) {
    // ambil nilai id dari url dan disimpan dalam variabel $id
    $no_mesin = ($_GET["namakelas"]);

    // menampilkan data dari database yang mempunyai id=$id
    $query = "SELECT * FROM kelas WHERE nama_kelas='$no_mesin'";
...
<body>
                            ...
                            <center>
                                ...
                                ?>
                                    <div class="col-md-3 mb-3">
                                        <input type="text" class="qr-input form-control" id="nomer" value="<?php echo $row['nama_kelas']; ?>" readonly>
                                        <br>
    ...
    const noMesinText = "<?php echo htmlspecialchars($row['nama_kelas']); ?>"; // Mendapatkan nama kelas dari PHP
    ...
    // Download QR code dengan nama kelas sebagai nama file
    document.getElementById('download-btn').addEventListener('click', function() {
        var canvas = document.querySelector('#qrcode canvas');
        var link = document.createElement('a');
        link.href = canvas.toDataURL('image/png');
        link.download = noMesinText + '.png'; // Gunakan nama kelas sebagai nama file
        link.click();
    });
</script>
