                            ...
                            <form method="POST" action="">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" id="startDate" name="startDate" class="form-control" required value="<?= isset($_POST['startDate']) ? $_POST['startDate'] : date('Y-m-01') ?>">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="endDate">Tanggal Akhir:</label>
                                        <input type="date" id="endDate" name="endDate" class="form-control" required value="<?= isset($_POST['endDate']) ? $_POST['endDate'] : date('Y-m-t') ?>">
                                    </div>
