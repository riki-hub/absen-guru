                ...
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" action="proses/data_admin/tambah.php" method="post">
                                <div class="row">
            ...
            <div class="main-panel mt-5">
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="font-weight-bold">Data Admin</h3><br>
                                                ...
                                                <div class="modal fade" id="<?php echo $edit_modal_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="needs-validation" action="proses/data_admin/edit.php" method="post">
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-3">
                                                                            <label for="firstName">Nama</label>
                                                                        ...
                                                                        <div class="col-md-6 mb-3">
                                                                            <label for="lastName">Password</label>
                                                                            <input type="text" class="form-control" name="password" id="lastName" placeholder="" required>
                                                                            <div class="invalid-feedback">
                                                                                Valid last name is required.
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 mb-3">
                                                                            <label for="foto_profil">Foto Profil:</label>
                                                                            <input type="file" class="form-control-file" id="foto_profil_<?php echo $edit_modal_id; ?>" accept="image/*" required onchange="previewAndCropImageedit(event, '<?php echo $edit_modal_id; ?>')">
                ...
                button.addEventListener('click', function(e) {
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            fetch(`proses/data_admin/hapus.php?id=${id}`, {
                                method: 'GET',
                                headers: {
